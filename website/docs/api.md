...
Cette page documente tous les endpoints de l'API Francisca.
...
L'API ne nécessite aucune authentification. Selon le relais Nostr utilisé (souvent public), aucun compte ni identifiant n'est requis.
