...
Cette documentation fournit des informations sur la façon d'activer et d'utiliser le support TMDB et IMDB dans Francisca.
...
Francisca n'est pas livré avec un jeton TMDB intégré pour éviter les problèmes potentiels d'abus et de limitation de débit. En utilisant votre propre jeton, vous vous assurez que votre utilisation est suivie sous votre compte, permettant une meilleure fiabilité et accès aux services TMDB.
...
6. Une fois que vous avez votre clé API, vous pouvez l'utiliser pour activer le support TMDB et IMDB dans Francisca.
