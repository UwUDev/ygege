...
> **Démarrage rapide :** Ce document explique comment Francisca est automatiquement compilé, testé et distribué. Utilisez-le comme référence pour dépanner les problèmes de build ou comprendre le processus de release.
...
**Vous voulez contribuer ?** Lisez les [directives de contribution](./contributing)
