...
This documentation provides information on how to enable and use TMDB and IMDB support in Francisca.
...
Francisca does not ship with a built-in TMDB token to avoid potential abuse and rate-limiting issues. By using your own token, you ensure that your usage is tracked under your account, allowing for better reliability and access to TMDB services.
...
6. Once you have your API key, you can use it to enable TMDB support in Francisca.