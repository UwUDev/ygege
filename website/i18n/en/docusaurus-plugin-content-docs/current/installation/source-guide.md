...
# Building Francisca from Source

This guide explains how to build Francisca from source on different platforms.
...
# Binary will be at: target/release/francisca (or francisca.exe on Windows)
```
...
After building, you can run Francisca:
...
Check the [Releases](https://github.com/UwUDev/francisca/releases) page for pre-built binaries.
