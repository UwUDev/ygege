...
# Francisca CI/CD Pipeline Guide

> **Quick Start:** This document explains how Francisca is automatically built, tested, and distributed. Use this as a reference for troubleshooting build issues or understanding the release process.

## 📋 Table of Contents
- [What Gets Built Automatically](#what-gets-built-automatically)
- [How to Get Francisca](#how-to-get-francisca)
...
Every time code is pushed to GitHub, our automated system builds Francisca for multiple platforms:
...
1. Go to [GitHub Actions](https://github.com/UwUDev/francisca/actions)
2. Click on the latest successful workflow run
3. Scroll to **"Artifacts"** section
4. Download the file matching your system:
   - **Linux (most systems):** `francisca-linux-gnu-x86_64.zip`
   - **Linux (ARM/Raspberry Pi):** `francisca-linux-gnu-aarch64.zip` or `francisca-linux-gnu-armv7.zip`
...
**Want smaller files?** Look for `-upx` versions (e.g., `francisca-linux-gnu-x86_64-upx.zip`)
...
Every Francisca binary includes build information:
...
When you start Francisca, it automatically logs version info:
...
Not listed? Open an [issue](https://github.com/UwUDev/francisca/issues) requesting your platform.

### ❓ "Docker pull fails or image not found"

**Check:**
1. Spelling: `uwucode/francisca` (not `uwudev`)
2. Tag exists: `develop`, `latest`, `stable`, or version number
3. Try alternative registry: `ghcr.io/uwudev/francisca:latest`
...
2. **Version info:** Output of `./francisca --version`
...
View with: `docker inspect uwucode/francisca:latest`
...
**Found a bug?** [Open an issue](https://github.com/UwUDev/francisca/issues)
