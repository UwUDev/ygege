...
Le workflow de release compile, teste et publie automatiquement les binaires Francisca et les images Docker lorsque vous
créez un nouveau tag de version (par exemple, `v1.0.0`).
...
**Note** : Utilisez le versionnement sémantique standard. Les tags Docker `:latest` seront automatiquement assignés aux
releases stables.
